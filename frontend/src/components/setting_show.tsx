...
const Radio = ({ onLogout }: { onLogout?: () => void }) => {
  const navigate = useNavigate();
  return (
    <StyledWrapper>
      <div className="input">
        <button className="value" onClick={() => navigate("/profile")}>
        ...
        <button className="value" onClick={onLogout}>
          <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path fill="#7D8590" d="M17 7l-1.41 1.41L18.17 11H8v2h10.17l-2.58 2.58L17 17l5-5zM4 5h8V3H4c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h8v-2H4V5z"/>
          </svg>
          退出登录
        </button>
      </div>
...
const StyledWrapper = styled.div`
  ...
  .value:last-child svg {
    color: rgba(17, 187, 214, 1);
  }`;
