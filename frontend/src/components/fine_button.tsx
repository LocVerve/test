  ...
  return (
    <StyledWrapper>
      <div className="btn-container">
        <div className="btn-drawer transition-top">prossional...</div>
        <div className="btn-drawer transition-bottom">servie</div>
        <button className="btn" onClick={handleClick}>
          <span className="btn-text">{children || "Get Offer"}</span>
        </button>
